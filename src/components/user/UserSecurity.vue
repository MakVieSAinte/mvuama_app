  ...
  <Card>
    ...
    <CardContent class="space-y-6">
      ...
      <div class="space-y-4 pt-6">
        ...
        <Button variant="outline" :disabled="isEnabling2FA" @click="toggleTwoFA" class="w-full">
          <span v-if="isEnabling2FA">Configuration en cours...</span>
          <span v-else
            >{{ twoFAEnabled ? 'Désactiver' : 'Activer' }} l'authentification à deux facteurs</span
          >
        </Button>
      </div>
      ...
      <div class="pt-6 border-t">
        ...
        <p class="text-sm text-muted-foreground mb-4">
          Une fois que vous supprimez votre compte, toutes vos données seront définitivement
          perdues.
        </p>
