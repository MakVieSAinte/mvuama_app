<template>
  ...
  >
    ...
    <div class="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
      ...
      <div class="relative z-20 mt-auto">
        <blockquote class="space-y-2">
          <p class="text-lg">
            &ldquo;Vérifiez votre boîte de réception pour suivre les instructions de
            réinitialisation de votre mot de passe.&rdquo;
          </p>
    ...
    <!-- Partie droite: confirmation (visible sur tous les écrans) -->
    <div class="flex h-full w-full items-center justify-center p-4 sm:p-6 lg:p-8">
      <div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px] max-w-[90vw]">
        <div class="flex flex-col space-y-2 text-left mb-4">
          <h1 class="text-3xl sm:text-4xl font-semibold tracking-tight">Email envoyé</h1>
          <p class="text-sm sm:text-md text-muted-foreground">
            Consultez votre messagerie pour réinitialiser votre mot de passe
          </p>
        </div>
...
import ForgotPasswordConfirmation from '@/components/auth/ForgotPasswordConfirmation.vue'

export default defineComponent({
  name: 'ForgotPasswordConfirmationView',
  components: {
    ForgotPasswordConfirmation,
  },
  setup() {
